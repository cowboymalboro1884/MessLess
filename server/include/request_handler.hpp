...
public:
    ...
    [[nodiscard]] QJsonDocument add_user_to_project(const QJsonObject &request
    ) const;
    [[nodiscard]] QJsonDocument delete_user_from_project(
        const QJsonObject &request
    ) const;
    ...
    [[nodiscard]] QJsonDocument add_user_to_task(const QJsonObject &request
    ) const;
    [[nodiscard]] QJsonDocument delete_user_from_task(const QJsonObject &request
    ) const;
    ...
    [[nodiscard]] QJsonDocument get_company_chat(const QJsonObject &request
    ) const;
    [[nodiscard]] QJsonDocument get_project_chat(const QJsonObject &request
    ) const;
