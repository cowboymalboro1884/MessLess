...
QJsonDocument RequestHolder::validate_user(const QJsonObject &request) const noexcept {
    ...
    json_response_object["type"] = "got_status_of_authorization";
    json_response_object["email"] = QString::fromStdString(is_login_success.email);
    json_response_object["password"] =
        QString::fromStdString(is_login_success.password);
    json_response_object["user_role"] =
    ...
    if (is_login_success.email.empty() || is_login_success.password.empty() ||
        ...
        json_response_object["error_text"] = "couldn't authorize";
...
QJsonDocument RequestHolder::register_company_with_admin(const QJsonObject &request
    ...
    json_response_object["type"] = "got_status_of_registration";
    json_response_object["email"] =
    ...
    if (is_registration_success.email.empty() ||
        ...
        json_response_object["status"] = "failed";
        json_response_object["error_text"] = "couldn't register";
    ...
    QJsonDocument response(json_response_object);
...
QJsonDocument RequestHolder::create_project(const QJsonObject &request) const noexcept {
    ...
    if (!messless::DatabaseProject::is_project_exist(
        ...
        json_response_object["type"] = "failed";
