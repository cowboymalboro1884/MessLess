...
public slots:
  ...
  void register_company_and_user(const QString &email, const QString &password,
  ...
  void add_user_to_company(const QString &sender_email,
  ...
  void get_tasks_of_projects(const QString &sender_email,
                             const QString &sender_password,
                             const QString &sender_user_role,

                             const QString &project_name);

  void get_projects_of_company(const QString &sender_email,
                               const QString &sender_password,
                               const QString &sender_user_role);

  void create_project(const QString &sender_email,
                      const QString &sender_password,
                      const QString &sender_user_role,

                      const QString &project_name, const QString &project_bio);

  void add_user_to_project(const QString &sender_email,
                           const QString &sender_password,
                           const QString &sender_user_role,
  ...
  void delete_user_to_project(const QString &sender_email,
                              const QString &sender_password,
                              const QString &sender_user_role,
  ...
  void delete_task(const QString &sender_email, const QString &sender_password,
                   const QString &sender_user_role,

                   const QString &task_name, const QString &project_name);

  void change_task_condition(const QString &sender_email,
                             const QString &sender_password,
                             const QString &sender_user_role,
  ...
  void send_message_to_company(const QString &sender_email,
                               const QString &sender_password,
                               const QString &sender_user_role,

                               const QString &message);

  void send_message_to_project(const QString &sender_email,
                               const QString &sender_password,
                               const QString &sender_user_role,
