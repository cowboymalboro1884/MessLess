...
void QuerySender::check_credentials(const QString &email,
...
void QuerySender::register_company_and_user(const QString &email,
                                            const QString &password,
...
void QuerySender::add_user_to_company(const QString &sender_email,
...
void QuerySender::get_tasks_of_projects(const QString &sender_email,
                                        const QString &sender_password,
                                        const QString &sender_user_role,
...
void QuerySender::get_projects_of_company(const QString &sender_email,
                                          const QString &sender_password,
                                          const QString &sender_user_role) {
  QJsonObject json_query;
...
void QuerySender::create_project(const QString &sender_email,
                                 const QString &sender_password,
                                 const QString &sender_user_role,
...
void QuerySender::add_user_to_project(const QString &sender_email,
                                      const QString &sender_password,
                                      const QString &sender_user_role,
...
void QuerySender::delete_user_to_project(const QString &sender_email,
                                         const QString &sender_password,
                                         const QString &sender_user_role,
...
void QuerySender::delete_project(const QString &sender_email,
                                 const QString &sender_password,
                                 const QString &sender_user_role,
...
void QuerySender::create_task(const QString &sender_email,
                              const QString &sender_password,
                              const QString &sender_user_role,
...
void QuerySender::delete_task(const QString &sender_email,
                              const QString &sender_password,
                              const QString &sender_user_role,
...
void QuerySender::change_task_condition(const QString &sender_email,
                                        const QString &sender_password,
                                        const QString &sender_user_role,
...
void QuerySender::send_message_to_company(const QString &sender_email,
                                          const QString &sender_password,
                                          const QString &sender_user_role,
...
void QuerySender::send_message_to_project(const QString &sender_email,
                                          const QString &sender_password,
                                          const QString &sender_user_role,
