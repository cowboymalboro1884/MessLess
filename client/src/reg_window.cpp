...
reg_window::reg_window(QWidget *parent)
    ...
    connect(
        this, SIGNAL(pushButtonSignIn_clicked()), this,
...
QString reg_window::getBio() {
    return ui->companyBioLineEdit->text();
}

QString reg_window::getCompName() {
    return ui->companyNameLineEdit->text();
}

QString reg_window::getConfPass() {
    return ui->confirmLineEdit->text();
}
...
void reg_window::on_pushButtonBack_clicked() {
