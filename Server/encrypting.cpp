...
std::string Encrypting::get_hash(std::string &str) {
...
std::string Encrypting::get_password_hash(
...
Encrypting::Encrypting(std::string salt)
    : private_salt(std::move(salt)) {
}

Encrypting::Encrypting() : private_salt() {
}

std::string Encrypting::get_random_string() {
